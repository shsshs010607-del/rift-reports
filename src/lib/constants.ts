...
export const RIFTBOUND_NEWS = [
  ...
  },
  {
    ...
    date: "2026-09-04",
    url: "https://playriftbound.com/ko-KR/news/announcements/introducing-the-new-playriftboundcom",
  },
  {
    tag: "공지",
    ...
    date: "2026-09-04",
    url: "https://playriftbound.com/ko-KR/news/announcements/product-drawing-faq/",
  },
  {
    tag: "대회",
    ...
    date: "2026-09-09",
    url: "https://playriftbound.com/en-us/news/organizedplay/singapores-top-decks",
  },
  {
    tag: "이벤트",
    ...
    date: "2026-09-11",
    url: "https://playriftbound.com/en-us/news/announcements/secret-garden-bundle-events/",
  },
  {
    tag: "대회",
    ...
    date: "2026-09-11",
    url: "https://playriftbound.com/en-us/news/organizedplay/all-eyes-on-los-angeles",
  },
] as const;
...
export const NAV_PRIMARY: readonly {
  ...
  { href: "/tiers?quiz=1", label: "MBTI 덱 찾기" },
  {
    ...
    children: [
      ...
      { href: "/nexus-promo-sim.html", label: "넥서스 나이트 프로모" },
    ],
  },
];
...
export const PRICE = {
  ...
  /**
   * OGN·OGS 세트 외에 개별로 편입할 카드.
   * (OP 프로모(OPP) 야스오·징크스는 JustTCG 이미지·시세가 부정확해서 뺌 —
   *  야스오·징크스는 OGN 스탠다드판이 이미 시세표에 있음.)
   * `set` = JustTCG set id, `q` = 검색어, `names` = 편입할 카드명(정확히 일치). 항목당 1콜.
   */
  extraCards: [] as { set: string; q: string; names: string[] }[],
  /** 무료 플랜 페이지 크기 제한. */
  pageLimit: 20,
  /** 우리 DB 스냅샷 보관 기간(일). */
  historyDays: 90,
