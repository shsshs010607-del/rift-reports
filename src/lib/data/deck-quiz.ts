...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    ...
    options: [
      { label: "인사도 없이 바로 달려든다 🏃", weights: { darius: 2, yi: 1, yasuo: 2, annie: 2, volibear: 1 } },
  ...
  },
  {
    ...
    question: "내 방/책상 상태는?",
    options: [
      { label: "미니멀, 필요한 것만 💼", weights: { garen: 2, darius: 2, yi: 1, annie: 2, leona: 1 } },
      { label: "난장판인데 다 이유가 있음", weights: { yasuo: 2, leesin: 2, ahri: 1, jinx: 2, yi: 1 } },
      { label: "장비·수집품이 벽을 채운다 🗄️", weights: { kaisa: 1, viktor: 1, volibear: 2, sett: 2 } },
      { label: "여기저기 함정처럼 물건이 놓여있음 🪤", weights: { teemo: 2, mf: 2 } },
    ],
  },
  {
    id: "losing",
    ...
    options: [
      { label: "한 방이면 뒤집는다… 던진다 🎲", weights: { jinx: 2, yasuo: 1, leesin: 2, annie: 2, yi: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "상대가 아무것도 못 하고 항복 🚫", weights: { leona: 2, mf: 1, teemo: 1, yasuo: 1 } },
    ],
  },
  {
    id: "pick",
    question: "덱 고를 때 나는?",
    options: [
      { label: "티어표 1위부터 본다 📊", weights: { yi: 1, kaisa: 1, viktor: 1 } },
      { label: "남들 안 쓰는 거 골라서 유행시킨다 😎", weights: { yasuo: 1, jinx: 2, teemo: 1, ahri: 2, leesin: 1 } },
      { label: "튜토리얼 없이도 굴릴 수 있는 거 🎮", weights: { garen: 2, darius: 1, annie: 1, sett: 1, volibear: 1, leona: 1 } },
