...
export const COMPONENTS: { name: string; desc: string }[] = [
  ...
  { name: "선발 챔피언 1장", desc: "전설과 같은 챔피언 태그를 가진 챔피언 유닛. 챔피언 구역에서 시작." },
  { name: "룬 덱 정확히 12장", desc: "전설 영역에 맞는 룬. 주 덱과 분리해서 셔플." },
  {
    name: "전장 카드 3장",
...
export const SETUP_SECTION: GuideSection = {
  ...
  title: "게임 준비",
  steps: [
    { title: "1. 전설 배치", body: "챔피언 전설을 전설 구역에 놓는다." },
    { title: "2. 선발 챔피언 배치", body: "선발 챔피언을 챔피언 구역에 놓는다." },
    {
      title: "3. 전장 세팅",
      body: "1v1은 각자 자기 전장 3장 중 1장을 무작위로 골라 전장 구역에 놓는다(나머지 2장은 이 게임에서 제외). 두 사람 것을 합쳐 전장 2개로 시작.",
    },
    { title: "4. 덱 셔플", body: "주 덱과 룬 덱을 각각 따로 셔플해 해당 구역에 놓는다." },
    {
      title: "5. 선/후공 결정",
      body: "공정한 무작위 방식으로 턴 순서를 정한다. 먼저 하는 사람이 선공.",
      tip: "1v1 후공은 첫 전개 단계에 룬을 1개 더 전개한다(선공 이득 보정).",
    },
    { title: "6. 4장 뽑기", body: "각 플레이어가 카드 4장을 뽑는다." },
    {
      title: "7. 멀리건",
      body: "턴 순서대로, 손에서 최대 2장을 골라 옆에 치우고 → 치운 만큼 새로 뽑은 뒤 → 치운 카드를 룬 덱이 아닌 주 덱으로 재활용(recycle) 후 셔플.",
      tip: "확률 낮은 손이면 과감하게 2장 교체.",
    },
  ],
};
...
export const TURN_PHASES: {
...
}[] = [
  {
    phase: "각성 단계",
    short: "Awaken",
    detail: "내가 통제하는 준비 가능한 모든 게임 오브젝트를 준비(ready) 상태로 되돌린다 — 지친(exhausted) 유닛·룬·도구가 다시 세워진다.",
  },
  {
    phase: "개시 단계 · 점거",
    short: "Holding",
    detail: "내 턴 시작 시점에 내가 통제 중인 전장 1개당 1점 획득('점거'). 팀전에서 아군이 점거 중인 전장은 이 턴 내가 점수화할 수 없다.",
  },
  {
    phase: "전개 단계",
    short: "Channel",
  ...
  },
  {
    phase: "뽑기 단계",
    short: "Draw",
    detail: "카드 1장을 뽑는다. 덱이 비어 뽑을 수 없으면 '소진(Burn Out)' — 폐기장을 덱으로 재활용·셔플하고 상대 1명에게 1점을 준 뒤 그래도 1장 뽑는다. 뽑기 단계가 끝나면 룬 구성이 비워진다.",
  },
  {
    phase: "주요 단계",
    short: "Action",
...
export const RESOURCES_SECTION: GuideSection = {
  ...
  title: "자원 — 에너지와 힘",
  intro:
    "카드 비용의 왼쪽 위 숫자는 '에너지', 그 아래 색 기호는 '힘'이다. 둘 다 룬에서 나온다.",
  steps: [
    {
      title: "에너지 (Energy)",
    ...
    {
      title: "룬 구성은 사라진다",
      body: "만들어 둔 에너지·힘은 뽑기 단계 끝과 턴 끝에 모두 사라진다. 필요할 때 그때그때 만들어 쓴다.",
    },
    {
      title: "가속 (Accelerate)",
  ...
  steps: [
    {
      ...
      body: "주요 단계에 유닛을 지치게 해서 기지↔전장으로 이동. 여러 유닛을 같은 목적지로 한 번에 이동 가능(모두 함께 지침). 지친 유닛은 기본 이동 불가.",
    },
    {
      title: "결전 (Showdown)",
...
export const SCORING_SECTION: GuideSection = {
  ...
  steps: [
    {
      title: "정복 (Conquer)",
      body: "이미 통제하지 않았고 이번 턴 점수화하지 않은 전장의 통제를 새로 얻으면 1점.",
    },
    {
      title: "점거 (Hold)",
      body: "내 턴이 시작될 때 이미 통제 중인 전장 1개당 1점(개시 단계에 자동).",
    },
    {
      title: "마지막 점수",
